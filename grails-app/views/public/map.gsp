...
<html>
    ...
    <div id="content">
      <div id="header">
        <!--Breadcrumbs-->
        <div id="breadcrumb"><a href="${grailsApplication.config.ala.baseURL}"><g:message code="public.map.breadcrumb.home" /></a> <a href="${Holders.config.ala.baseURL}/explore/"><g:message code="public.map.breadcrumb.explore" /></a><span class="current"><g:message code="public.map.breadcrumb.des" /></span></div>
